...
g = og(
   ...
   gg=[og('subgroup',
          ...
          # NOTE *BUG* : this, and not specifying it on use below, SHOULD WORK
          # but currently fails "complete"
          dd=[od('subgroup_dim_y')],
          vv=[ov('subgroup_var',
                 # dd=[od('root_dim_x'), od('subgroup_dim_y')],
                 # NOTE *BUG* : this, and specifying length above SHOULD WORK
                 dd=[od('root_dim_x'), od('subgroup_dim_y', 7)],
