# -*- coding: utf-8 -*-
#
# ncobj documentation build configuration file, created by
...
latex_documents = [
  ('index', 'ncobj.tex', u'ncobj Documentation',
   u'pp-mo', 'manual'),
]
...
man_pages = [
    ('index', 'ncobj', u'ncobj Documentation',
     [u'pp-mo'], 1)
]
...
texinfo_documents = [
  ('index', 'ncobj', u'ncobj Documentation',
   u'pp-mo', 'ncobj', 'One line description of project.',
   'Miscellaneous'),
]
...
doctest_global_setup = 'import netCDF4; import numpy'
